...
class FederatedServer:
    ...
    def aggregate_models(self):
        ...
        for client_id, (client_state, dataset_size) in self.client_models.items():
            ...
            logger.info(f"Client {client_id}: dataset size = {dataset_size}, weight = {weight:.4f}")
...
def main():
    ...
    if args.save_dir == '':
        args.save_dir = os.path.join('fl_server_results_final', f'soda10m_server_{timestamp}')
    else:
