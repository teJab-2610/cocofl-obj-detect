...
if __name__ == "__main__":
    ...
    if args.network =="s":
        model = nn_quantized.QYOLOv8s
    elif args.network == "n":
        model = nn_quantized.QYOLOv8n
    elif args.network == "m":
        model = nn_quantized.QYOLOv8m
    elif args.network == "l":
        model = nn_quantized.QYOLOv8l
    elif args.network == "x":
        model = nn_quantized.QYOLOv8x
